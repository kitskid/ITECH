...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception{
        httpSecurity
                ...
                .antMatchers("/img/**", "/admin/search", "/admin/orders", "/admin/status", "/admin/update/status", "/main/api/product/category", "/main/api/product/update", "/main/api/providers", "/main/api/provider/delete/{id}", "/main/api/provider/update", "main/api/provider/add", "/main/api/provider/avatar", "/main/api/provider/image/get/{filename:.+}", "/main/api/product/avatar/get/{filename:.+}", "/main/api/product/avatar", "/main/api/product/add","/main/api/delete/{id}", "/main/api/update", "main/api/postadmin/avatar/get/", "main/api/postadmin/avatar/get/{filename:.+}", "/main/api", "/main/api/postadmin", "main/api/postadmin/avatar").hasRole("ADMIN")
                .antMatchers("/main/api/providers/{login}","/main/api/products/{id}", "/main/api/product/category/provider", "/main/api/product/avatar", "/main/api/product/add", "/main/api/product/update").hasRole("PROVIDER")
